    ...
    <div className="rounded-xl border border-primary/25 bg-primary/5 p-4 mb-5">
      <div className="flex items-start gap-2.5">
        ...
        <div className="text-sm space-y-1.5">
          <p className="font-medium">Your Leadora membership automatically renews every month at $59 until canceled.</p>
          <ul className="space-y-1 text-muted-foreground text-xs sm:text-sm">
            ...
            <li>• Includes 100 Leadora credits each successful monthly billing cycle</li>
      ...
      {showCheckbox && (
        <label className="flex items-start gap-2.5 mt-4 cursor-pointer">
          ...
          <span className="text-sm">
            I consent to automatic monthly renewal of my Leadora membership at $59/month until I cancel, and I agree to these automatic-renewal terms.
          </span>
        </label>
      )}
    </div>
