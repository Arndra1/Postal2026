  ...
  return (
    <section id="who" className="max-w-7xl mx-auto px-6 py-20">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <h2 className="font-heading text-3xl md:text-4xl font-semibold text-foreground">Built for Businesses That Need Better Prospects</h2>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {audiences.map((a) => (
          <div key={a.label} className="glass-card p-5 text-center">
            <div className="w-10 h-10 rounded-full lady-gradient flex items-center justify-center mx-auto mb-3 shadow-sm">
              <a.icon className="w-5 h-5 text-white" />
            </div>
            <p className="text-sm font-medium leading-snug text-foreground">{a.label}</p>
          </div>
        ))}
      </div>
