  ...
  return (
    <section id="who" className="max-w-7xl mx-auto px-6 py-20">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white">Built for Businesses That Need Better Prospects</h2>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {audiences.map((a) => (
          <div key={a.label} className="bg-[#12131A] rounded-2xl border border-cyan-500/15 p-5 tech-card text-center">
            ...
            <p className="text-sm font-medium leading-snug text-slate-200">{a.label}</p>
          </div>
        ))}
      </div>
