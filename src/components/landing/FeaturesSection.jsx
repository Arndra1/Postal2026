  ...
  return (
    <section id="features" className="max-w-7xl mx-auto px-6 py-20">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <h2 className="font-heading text-3xl md:text-4xl font-semibold text-foreground">Everything You Need to Find and Work Better Leads</h2>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {features.map((f) => (
          <div key={f.title} className="glass-card p-6">
            <div className="w-11 h-11 rounded-xl lady-gradient flex items-center justify-center mb-4 shadow-md">
              <f.icon className="w-5 h-5 text-white" />
            </div>
            <h3 className="font-heading font-semibold mb-1.5 text-foreground">{f.title}</h3>
