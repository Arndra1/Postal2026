  ...
  return (
    <section id="responsible-use" className="max-w-7xl mx-auto px-6 py-20">
      <div className="max-w-3xl mx-auto text-center glass-card p-10">
        <div className="w-12 h-12 rounded-full lady-gradient flex items-center justify-center mx-auto mb-6 shadow-md">
          <ShieldCheck className="w-6 h-6 text-white" />
        </div>
        <h2 className="font-heading text-3xl md:text-4xl font-semibold text-foreground">Powerful Data. Responsible Use.</h2>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 mt-6 text-primary font-medium hover:text-primary/80 transition"
        >
