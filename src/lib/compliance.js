...
export const ACCURACY_NOTICE =
  "Public and third-party information may contain errors, outdated or incomplete information, duplicate records, or incorrect associations. Users should independently verify important information before relying on it. Leadora does not guarantee that every record is complete, current, or accurate.";
...
export const CERTIFICATIONS = [
  "I will use Leadora only for lawful purposes.",
  ...
  "I will not use Leadora as a consumer reporting agency, and I will not use Leadora data for prohibited eligibility decisions.",
  "I will not resell Leadora data unless specifically authorized.",
